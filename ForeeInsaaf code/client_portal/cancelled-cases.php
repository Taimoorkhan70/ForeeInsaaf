<?php
   session_start();
    include('../db/connection.php');
     ...
     $query = "SELECT * FROM `project` WHERE `user_id`='".$_SESSION['user']['user_id']."' and `status`='3'";
               ...
               <div class="row">
                  ...
                  <div class="col-xl-9 col-md-8">
                     ...
                     <nav class="user-tabs project-tabs">
                        ...
                        <li class="nav-item">
                              <a class="nav-link" href="manage-cases.php">All Cases</a>
                           </li>
                           <!-- <li class="nav-item">
                           ...
                           <li class="nav-item">
                              <a class="nav-link active" href="cancelled-cases.php">Cancelled Cases</a>
                           </li>
                        </ul>
                     </nav>
                     <?php

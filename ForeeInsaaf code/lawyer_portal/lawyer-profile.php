   ...
   if(isset($_SESSION['user'])){
      ...
      $user_email = $_GET['id'];
        ...
        $result = mysqli_query($connection,$select_query);
         ...
         $query ="SELECT * FROM `user_experience` where `user_id`='$user_email'";
         $res =mysqli_query($connection,$query);
     
   
         $query_1 ="SELECT * FROM `education` where `user_id`='$user_email'";
                     ...
                     <div class="breadcrumb-list">
                        <nav aria-label="breadcrumb" class="page-breadcrumb">
                           ...
                           <li class="breadcrumb-item"><a href="dashboard.php"><img src="../assets/img/home-icon.svg" alt="Post Author"> Home</a></li>
                              <li class="breadcrumb-item" aria-current="page">Lawyer Profile</li>
                           </ol>
                        </nav>
                     </div>
                  </div>
                           ...
                           <div class="provider-widget">
                              <div class="pro-info-left">
                                 ...
                                 <div class="profile-info" style='display:flex;flex-direction:column;align-items:center;justify-content:center'>
                                    ...
                                    <p class="profile-position" style="margin:0px;"><?php if($rows['category']==""){ echo "Lawyer"; }else{ echo $rows['category'];} ?></p>
                              ...
                              if(isset($_SESSION['user'])){
                                 ?>
                                    <div class="pro-info-right profile-inf">
                                       <a class="btn profile-edit-btn" href="lawyer-profile-settings.php">Edit Profile</a><br> 
                                    </div>
                                 <?php
                     ...
                     <div class="pro-view">
                        <nav class="provider-tabs mb-4">
                           <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="lawyer-proposels.php">
                                    <img src="assets/img/icon/tab-icon-02.png" height="25" alt="User Image">
                                    <p class="bg-blue">Proposels</p>
                                 </a>
                              </li>
                              <li class="nav-item">

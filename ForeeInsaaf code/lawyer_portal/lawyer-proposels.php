...
<html lang="en">
   ...
   <body class="dashboard-page">
                  ...
                  <div class="col-xl-9 col-md-8">
                     ...
                     <nav class="user-tabs mb-4">
                        <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                           <li class="nav-item">
                              <a class="nav-link active" href="lawyer-proposels.php">My Proposals</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link" href="ongoing-proposels.php">Ongoing Proposels</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link" href="completed-proposels.php">Completed Proposels</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link" href="#">Cancelled Proposels</a>
                           </li>
                        </ul>
                     </nav>
                     <div class="proposals-section">
                        ...
                        <?php 
                        $Q="SELECT *, pr.user_id as user FROM proposels p inner join project pr on pr.project_id=p.project_id where p.user_id='".$_SESSION['user']['user_id']."' order by p.id desc";
      ...
      if(isset($_POST['update'])){
          extract($_POST);
          $Q="UPDATE `proposels` SET `p_price`='$price',`p_hearings`='$hearings',`p_cover_desc`='$cover' WHERE `id`='$id'";

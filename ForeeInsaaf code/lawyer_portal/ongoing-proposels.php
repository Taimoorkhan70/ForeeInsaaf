                  ...
                  <div class="col-xl-9 col-md-8">
                     ...
                     <nav class="user-tabs mb-4">
                        <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                           ...
                           <li class="nav-item">
                              <a class="nav-link active" href="ongoing-proposels.php">Ongoing Proposels</a>
                           </li>
                           <li class="nav-item">
                     ...
                     <div class="proposals-section">
                        ...
                        <?php 
                        $Q="SELECT *, pr.user_id as user FROM proposels p inner join project pr on pr.project_id=p.project_id where p.user_id='".$_SESSION['user']['user_id']."' and p.p_status='2' order by p.id desc";
